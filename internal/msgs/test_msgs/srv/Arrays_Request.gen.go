...
import (
	...
	test_msgs_msg "github.com/TIERS/rclgo/internal/msgs/test_msgs/msg"
...
func init() {
	typemap.RegisterMessage("test_msgs/Arrays_Request", Arrays_RequestTypeSupport)
}
...
type _Arrays_RequestTypeSupport struct{}

func (t _Arrays_RequestTypeSupport) New() types.Message {
	return NewArrays_Request()
}

func (t _Arrays_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.test_msgs__srv__Arrays_Request
	return (unsafe.Pointer)(C.test_msgs__srv__Arrays_Request__create())
}

func (t _Arrays_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.test_msgs__srv__Arrays_Request__destroy((*C.test_msgs__srv__Arrays_Request)(pointer_to_free))
}

func (t _Arrays_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Arrays_Request)
	mem := (*C.test_msgs__srv__Arrays_Request)(dst)
...
func (t _Arrays_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Arrays_Request)
	mem := (*C.test_msgs__srv__Arrays_Request)(ros2_message_buffer)
	cSlice_bool_values := mem.bool_values[:]
...
func (t _Arrays_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__test_msgs__srv__Arrays_Request())
}
...
func Arrays_Request__Sequence_to_Go(goSlice *[]Arrays_Request, cSlice CArrays_Request__Sequence) {
	...
	*goSlice = make([]Arrays_Request, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		cIdx := (*C.test_msgs__srv__Arrays_Request__Sequence)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__srv__Arrays_Request * uintptr(i)),
		))
		Arrays_RequestTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(cIdx))
	}
}
func Arrays_Request__Sequence_to_C(cSlice *CArrays_Request__Sequence, goSlice []Arrays_Request) {
	...
	cSlice.data = (*C.test_msgs__srv__Arrays_Request)(C.malloc((C.size_t)(C.sizeof_struct_test_msgs__srv__Arrays_Request * uintptr(len(goSlice)))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity

	for i, v := range goSlice {
		cIdx := (*C.test_msgs__srv__Arrays_Request)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__srv__Arrays_Request * uintptr(i)),
		))
		Arrays_RequestTypeSupport.AsCStruct(unsafe.Pointer(cIdx), &v)
	}
}
func Arrays_Request__Array_to_Go(goSlice []Arrays_Request, cSlice []CArrays_Request) {
	for i := 0; i < len(cSlice); i++ {
		Arrays_RequestTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func Arrays_Request__Array_to_C(cSlice []CArrays_Request, goSlice []Arrays_Request) {
	for i := 0; i < len(goSlice); i++ {
		Arrays_RequestTypeSupport.AsCStruct(unsafe.Pointer(&cSlice[i]), &goSlice[i])
	}
}
